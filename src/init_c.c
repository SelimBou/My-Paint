...
static void init_menu_buttons(global_t *all)
{
    ...
    init_text_button(all, (text_button_t){15, "Edition", 39, sfWhite, 1480,
    40});
...
{
    init_text_button(all, (text_button_t){18, "New file", 30, sfBlue, 1350,
    110});
    init_text_button(all, (text_button_t){19, "Save file", 30, sfBlue, 1350,
    190});
    init_text_button(all, (text_button_t){20, "Open file", 30, sfBlue, 1350,
    270});
    init_text_button(all, (text_button_t){21, "Software", 30, sfBlue, 1610,
    190});
