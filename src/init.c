...
void init_menu(global_t *all)
{
    ...
    IMAGE = malloc(sizeof(image_t) * 22);
...
{
    init_button(all, 14, 550, 25, sfBlack);
    init_button(all, 0, 400, 25, sfRed);
    init_button(all, 1, 250, 25, sfBlue);
    init_button(all, 2, 100, 25, sfGreen);
    ...
    init_button(all, 10, BUTTON[10].pos.x, BUTTON[10].pos.y,
        BUTTON[10].buttoncol);
    init_button(all, 11, BUTTON[11].pos.x, BUTTON[11].pos.y,
        BUTTON[11].buttoncol);
    init_button(all, 12, BUTTON[12].pos.x, BUTTON[12].pos.y,
        BUTTON[12].buttoncol);
    init_button(all, 13, BUTTON[13].pos.x, BUTTON[13].pos.y,
        BUTTON[13].buttoncol);
}
